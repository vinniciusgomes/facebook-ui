  ...
  return (
    <div className="nav">
      <div className="firstcolumn">
        <a href="https://github.com/vinniciusgomes" title="Ir para a página inicial do Facebook" className="githubURL">
      ...
      <div className="notifications">
        <div title="Perfil" className="perfil">
          ...
          <span className="border-right-nav text-nav">Vinnicius</span>
        </div>
